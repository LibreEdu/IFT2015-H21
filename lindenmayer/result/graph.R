...
if (is.data.frame(get('y2'))) lines(x2[order(x2)], y2[order(x2)], xlim=range(x2), ylim=range(y2), lwd=1, col=color2)
if (is.data.frame(get('y3'))) lines(x2[order(x2)], y2[order(x2)], xlim=range(x2), ylim=range(y2), lwd=1, col=color2)
